...
namespace test {
using cudf::experimental::aggregation;
using namespace cudf::experimental::groupby;

#define MIN cudf::experimental::aggregation::Kind::MIN
#define MAX cudf::experimental::aggregation::Kind::MAX
#define SUM cudf::experimental::aggregation::Kind::SUM
#define MEAN cudf::experimental::aggregation::Kind::MEAN
#define COUNT cudf::experimental::aggregation::Kind::COUNT
#define MEDIAN cudf::experimental::aggregation::Kind::MEDIAN
#define QUANTILE cudf::experimental::aggregation::Kind::QUANTILE
// #define VARIANCE cudf::experimental::aggregation::Kind::VARIANCE
// #define STD cudf::experimental::aggregation::Kind::STD
 ...
 *---------------------------------------------------------------------------**/
template <aggregation::Kind op> struct corresponding_functor { using type = void; };
 ...
 *---------------------------------------------------------------------------**/
template <typename SourceType, aggregation::Kind op,
          typename dummy = void>
